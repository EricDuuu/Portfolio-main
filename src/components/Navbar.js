...
export default function Navbar(props) {
  ...
  return (
    <div
      className={`${isScrolingToTop ? "fixed z-50 sm:translate-y-0 sm:opacity-100" : ""
        } w-full bg-slate-50 dark:bg-[#222529] transition-opacity duration-500 ease-in-out ${!isAtTop ? "shadow-lg" : ""
        }`}
    >
      <div className="flex px-8 py-4 sm:px-0">
        ...
        >
          <a
            type="button"
            href="#home"
            className={`${props.navIndex === 1 ? "text-custom-red" : ""
          ...
          <a
            type="button"
            href="#experience"
            className={`${props.navIndex === 2 ? "text-custom-red" : ""
              } cursor-pointer hover:text-custom-red`}
          ...
          <a
            type="button"
            href="#projects"
            className={`${props.navIndex === 3 ? "text-custom-red" : ""
              } cursor-pointer hover:text-custom-red`}
          ...
          <a
            type="button"
            href="#others"
            className={`${props.navIndex === 4 ? "text-custom-red" : ""
              } cursor-pointer hover:text-custom-red`}
          ...
          <a
            type="button"
            href="#contact"
            className={`${props.navIndex === 5 ? "text-custom-red" : ""
              } cursor-pointer hover:text-custom-red`}
